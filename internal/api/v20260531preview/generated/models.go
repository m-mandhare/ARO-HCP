...
type Condition struct {
	...
	// READ-ONLY; A programmatic identifier indicating the reason for the condition's last transition. The value should be a CamelCase
	...
	// READ-ONLY; Type of the condition in CamelCase or in foo.example.com/CamelCase. The regex it matches is (dns1123SubdomainFmt/)?(qualifiedNameFmt).
	Type *ConditionType
}
...
type ExternalAuthProperties struct {
	...
	// READ-ONLY; The observed conditions of the resource.
