...
func (e ExternalAuthProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "conditions", e.Conditions)
...
func (e *ExternalAuthProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "clients":
			...
			delete(rawMsg, key)
		case "conditions":
			err = unpopulate(val, "Conditions", &e.Conditions)
			delete(rawMsg, key)
		case "issuer":
...
func (h HcpOpenShiftClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "conditions", h.Conditions)
...
func (h *HcpOpenShiftClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "clusterImageRegistry":
			...
			delete(rawMsg, key)
		case "conditions":
			err = unpopulate(val, "Conditions", &h.Conditions)
			delete(rawMsg, key)
		case "console":
...
func (n NodePoolProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "conditions", n.Conditions)
...
func (n *NodePoolProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "autoScaling":
			...
			delete(rawMsg, key)
		case "conditions":
			err = unpopulate(val, "Conditions", &n.Conditions)
			delete(rawMsg, key)
		case "labels":
