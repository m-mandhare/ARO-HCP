...
func NewRoleDefinitionsCachedReader(inner azureclient.RoleDefinitionsClient) RoleDefinitionsCachedReader {
	return newRoleDefinitionsCachedReader(inner, utilsclock.RealClock{})
}

func newRoleDefinitionsCachedReader(inner azureclient.RoleDefinitionsClient, clock utilsclock.PassiveClock) *roleDefinitionsCachedReader {
